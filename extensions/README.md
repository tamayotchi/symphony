...
In Symphony Elixir, the runtime resolves configured extension paths relative to `WORKFLOW.md`, expands them to absolute paths, and passes them explicitly to Pi.
