defmodule SymphonyElixirWeb.StaticAssets do
  ...
  @kanban_css_path Path.expand("../../priv/static/kanban.css", __DIR__)
  ...
  @external_resource @kanban_css_path
  ...
  @kanban_css File.read!(@kanban_css_path)
  ...
  @assets %{
    ...
    "/kanban.css" => {"text/css", @kanban_css},
