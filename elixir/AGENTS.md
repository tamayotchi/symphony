...
This directory contains the Elixir agent orchestration service that polls Linear, creates per-issue workspaces, and runs either Codex in app-server mode or Pi in RPC mode.
...
- Workspace safety is critical:
  - Never run worker cwd in source repo.
